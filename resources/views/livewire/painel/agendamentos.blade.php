    ...
    <div class="mb-8 space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="w-full flex justify-center items-end">
                <button wire:click="limparFiltros" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 transition-colors text-sm font-medium w-full max-w-[150px]">
                    Limpar Filtros
                </button>
            </div>                
        </div>
