        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="btn-group" role="group">
                <button wire:click="$set('filtro_periodo', 'hoje')" 
                        class="btn btn-sm {{ ($filtro_periodo ?? 'hoje') == 'hoje' ? 'btn-primary' : 'btn-outline-primary' }}">
                    Hoje
                </button>
                <button wire:click="$set('filtro_periodo', 'semana')" 
                        class="btn btn-sm {{ ($filtro_periodo ?? 'hoje') == 'semana' ? 'btn-primary' : 'btn-outline-primary' }}">
                    Semana
                </button>
                <button wire:click="$set('filtro_periodo', 'mes')" 
                        class="btn btn-sm {{ ($filtro_periodo ?? 'hoje') == 'mes' ? 'btn-primary' : 'btn-outline-primary' }}">
                    Mês
                </button>
            </div>
